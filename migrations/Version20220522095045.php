 ...
 */
final class Version20220522095045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film DROP category_id_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film ADD category_id_id INT DEFAULT NULL');
    }
}
